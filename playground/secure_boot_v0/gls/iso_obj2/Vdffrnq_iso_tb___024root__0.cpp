...
VlCoroutine Vdffrnq_iso_tb___024root___eval_initial__TOP__Vtiming__0(Vdffrnq_iso_tb___024root* vlSelf) {
    ...
    VL_WRITEF_NX("[ISO] t=%0t rn=0 d=1 q=%b (expect q=0, reset asserted)\n",0,
                 64,VL_TIME_UNITED_Q(1000),-9,1,(IData)(vlSelfRef.dffrnq_iso_tb__DOT__q));
    co_await vlSelfRef.__VdlySched.delay(0x00000000000186a0ULL, 
                                         nullptr, "dffrnq_iso_tb.sv", 
                                         13);
    VL_WRITEF_NX("[ISO] t=%0t rn=%b d=%b q=%b (expect q=0, still in reset)\n",0,
                 64,VL_TIME_UNITED_Q(1000),-9,1,(IData)(vlSelfRef.dffrnq_iso_tb__DOT__rn),
                 1,vlSelfRef.dffrnq_iso_tb__DOT__d,
                 1,(IData)(vlSelfRef.dffrnq_iso_tb__DOT__q));
    ...
    VL_WRITEF_NX("[ISO] t=%0t rn=%b d=%b q=%b (expect q=0, still in reset, after clock edges)\n",0,
                 64,VL_TIME_UNITED_Q(1000),-9,1,(IData)(vlSelfRef.dffrnq_iso_tb__DOT__rn),
                 1,vlSelfRef.dffrnq_iso_tb__DOT__d,
                 1,(IData)(vlSelfRef.dffrnq_iso_tb__DOT__q));
    ...
    co_await vlSelfRef.__VtrigSched_h6d61be83__0.trigger(0U, 
                                                         ...
                                                         "dffrnq_iso_tb.sv", 
                                                         18);
    VL_WRITEF_NX("[ISO] t=%0t rn=%b d=%b q=%b (expect q=1 now: reset released, D=1 captured on edge)\n",0,
                 64,VL_TIME_UNITED_Q(1000),-9,1,(IData)(vlSelfRef.dffrnq_iso_tb__DOT__rn),
                 1,vlSelfRef.dffrnq_iso_tb__DOT__d,
                 1,(IData)(vlSelfRef.dffrnq_iso_tb__DOT__q));
    ...
    vlSelfRef.__VactTriggered[0U] = (QData)((IData)(
                                                    ((vlSelfRef.__VdlySched.awaitingCurrentTime() 
                                                     ...
                                                     | ((((~ (IData)(vlSelfRef.dffrnq_iso_tb__DOT__rn)) 
                                                          & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__dffrnq_iso_tb__DOT__rn__0)) 
                                                         << 1U) 
...
void Vdffrnq_iso_tb___024root___nba_sequent__TOP__0(Vdffrnq_iso_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdffrnq_iso_tb___024root___nba_sequent__TOP__0\n"); );
    Vdffrnq_iso_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.dffrnq_iso_tb__DOT__q = ((IData)(vlSelfRef.dffrnq_iso_tb__DOT__rn) 
                                       & (IData)(vlSelfRef.dffrnq_iso_tb__DOT__d));
}

void Vdffrnq_iso_tb___024root___eval_nba(Vdffrnq_iso_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdffrnq_iso_tb___024root___eval_nba\n"); );
    Vdffrnq_iso_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((3ULL & vlSelfRef.__VnbaTriggered[0U])) {
        Vdffrnq_iso_tb___024root___nba_sequent__TOP__0(vlSelf);
    }
}
...
bool Vdffrnq_iso_tb___024root___eval_phase__nba(Vdffrnq_iso_tb___024root* vlSelf) {
    ...
    if (__VnbaExecute) {
        Vdffrnq_iso_tb___024root___eval_nba(vlSelf);
