...
`endif
  ...
  \gold.tlul_sram_if_macro_ocd_21bank gold (
...
`endif
  ...
  \gate.tlul_sram_if_macro_ocd_21bank gate (
    .\__pi_clk_i (\__pi_clk_i ),
    .\__pi_en_ifetch_i (\__pi_en_ifetch_i ),
    .\__pi_rst_ni (\__pi_rst_ni ),
    .\__pi_tl_i (\__pi_tl_i ),
...
module \gold.tlul_sram_if_macro_ocd_21bank (
  input  [  0:0] \__pi_clk_i ,
  input  [  3:0] \__pi_en_ifetch_i ,
  input  [  0:0] \__pi_rst_ni ,
  input  [113:0] \__pi_tl_i ,
...
module \gate.tlul_sram_if_macro_ocd_21bank (
  input  [  0:0] \__pi_clk_i ,
  input  [  3:0] \__pi_en_ifetch_i ,
  input  [  0:0] \__pi_rst_ni ,
  input  [113:0] \__pi_tl_i ,
