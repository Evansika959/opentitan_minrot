...
module tlul_sram_if_macro_ocd_multibank_gen #(
  ...
  parameter int unsigned NumBanks  = 8           // number of 1 KiB (256-word) tiles
) (
  input  logic                  clk_i,
  input  logic                  rst_ni,
...
endmodule : tlul_sram_if_macro_ocd_multibank_gen
