...
// Reuse SHA-256 from ROM: for simplicity, paste the same SHA-256 code here,
// or compile it once into a common object (recommended).
// For brevity in this snippet, assume you compile sha256.c shared by ROM/ROM_EXT.
#include "sha256_shared.h"  // <-- you can create by extracting SHA-256 code into shared files
